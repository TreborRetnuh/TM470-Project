...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = findViewById(R.id.result); // is it this?
                ...
                try {
                    ...
                    for(int i = 0; i < imageSize; i ++){
                        for(int j = 0; j < imageSize; j++){
                            ...
                            byteBuffer.putFloat(((val >> 16) & 0xFF) * (1.f));//Using 255 gets same prediction
                            byteBuffer.putFloat(((val >> 8) & 0xFF) * (1.f));//(1.f / 255))
                    ...
                    // Find the biggest confidence index and set it as maxPos
                    int maxPos = 0;
                    ...
                    String maxConfidenceText = String.format("%.2f", maxConfidence);
                    //maxConfidenceText =Float.toString(maxConfidence);
                    confidence.setText(maxConfidenceText);
